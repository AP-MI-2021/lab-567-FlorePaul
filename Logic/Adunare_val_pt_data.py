...
def adunare_valoare_for_data(lst_cheltuieli, data: str, val: int, undo_list: list, redo_list: list):
    ...
    :param redo_list: Lista de liste, ce se modifica in urma apelarii fiecarei Undo, sau devine lista vida cand apelam
    ...
    if not minim_o_cheltuiala: "nu am facut nici o modificare"
